...
Precise, topic-scoped rules live in `.Codex/rules/`:

| File | Covers |
|------|--------|
| [`architecture.md`](.Codex/rules/architecture.md) | Design patterns, layer responsibilities, extension points |
| [`rl-environment.md`](.Codex/rules/rl-environment.md) | WSNEnv API, observation space, reward weights, BatteryModel |
| [`agents-training.md`](.Codex/rules/agents-training.md) | BaseAgent interface, DDQN internals, Trainer API, hyperparameters |
| [`api-design.md`](.Codex/rules/api-design.md) | Sync/async routing, validation, task lifecycle, response shape |
| [`config-paths.md`](.Codex/rules/config-paths.md) | Config singleton, YAML structure, path handling |
| [`testing.md`](.Codex/rules/testing.md) | Conftest singleton reset, fixture sizes, test patterns |
| [`artifacts.md`](.Codex/rules/artifacts.md) | Run ID format, file naming, metadata schema |

Directory-level context: [`frontend/AGENTS.md`](frontend/AGENTS.md) · [`backend/AGENTS.md`](backend/AGENTS.md) · [`src/AGENTS.md`](src/AGENTS.md)
...
**`backend/`** — Flask REST API layer. See [`backend/AGENTS.md`](backend/AGENTS.md).

**`frontend/`** — Single-page UI (no build step). See [`frontend/AGENTS.md`](frontend/AGENTS.md).

**`src/`** — Pure RL core (envs, agents, training loop). See [`src/AGENTS.md`](src/AGENTS.md).
